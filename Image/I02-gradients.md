...
## Info
Chaining operators with the Invert blend mode can lead to complex results.
...
## Info
Invert blend mode can also combine multiple [RadialGradient] operators into patterns.
